    ...
    scene:`<svg viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
      <defs>
        <linearGradient id="ksky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stop-color="#020510"/><stop offset="50%" stop-color="#050818"/><stop offset="100%" stop-color="#030610"/>
        </linearGradient>
      </defs>
      <rect width="420" height="260" fill="url(#ksky)"/>
      <rect x="185" y="30" width="18" height="165" rx="1" fill="rgba(8,12,30,0.95)"/>
      <polygon points="185,30 194,10 203,30" fill="rgba(8,12,30,0.95)"/>
      <rect x="183" y="28" width="22" height="3" fill="rgba(30,100,200,0.3)"/>
      <rect x="50" y="100" width="28" height="100" fill="rgba(6,10,25,0.9)"/>
      <rect x="82" y="80" width="22" height="120" fill="rgba(7,11,26,0.9)"/>
      <rect x="108" y="110" width="32" height="90" fill="rgba(6,10,25,0.9)"/>
      <rect x="144" y="90" width="20" height="110" fill="rgba(7,11,26,0.9)"/>
      <rect x="168" y="120" width="14" height="80" fill="rgba(6,10,25,0.9)"/>
      <rect x="210" y="115" width="16" height="85" fill="rgba(6,10,25,0.9)"/>
      <rect x="230" y="85" width="24" height="115" fill="rgba(7,11,26,0.9)"/>
      <rect x="258" y="100" width="30" height="100" fill="rgba(6,10,25,0.9)"/>
      <rect x="292" y="70" width="20" height="130" fill="rgba(7,11,26,0.9)"/>
      <rect x="316" y="95" width="26" height="105" fill="rgba(6,10,25,0.9)"/>
      <rect x="346" y="115" width="32" height="85" fill="rgba(7,11,26,0.9)"/>
      <rect x="55" y="105" width="4" height="3" fill="rgba(255,220,120,0.5)"/>
      <rect x="63" y="105" width="4" height="3" fill="rgba(255,220,120,0.3)"/>
      <rect x="55" y="112" width="4" height="3" fill="rgba(255,220,120,0.4)"/>
      <rect x="63" y="120" width="4" height="3" fill="rgba(255,220,120,0.6)"/>
      <rect x="88" y="88" width="3" height="3" fill="rgba(255,220,120,0.4)"/>
      <rect x="95" y="95" width="3" height="3" fill="rgba(255,220,120,0.5)"/>
      <rect x="265" y="108" width="4" height="3" fill="rgba(255,220,120,0.5)"/>
      <rect x="273" y="115" width="4" height="3" fill="rgba(255,220,120,0.3)"/>
      <rect x="298" y="80" width="3" height="3" fill="rgba(255,220,120,0.4)"/>
      <rect x="305" y="88" width="3" height="3" fill="rgba(255,220,120,0.5)"/>
      <rect x="85" y="75" width="16" height="5" rx="1" fill="rgba(77,184,255,0.5)"/>
      <rect x="263" y="97" width="20" height="4" rx="1" fill="rgba(77,184,255,0.45)"/>
      <rect x="148" y="88" width="12" height="4" rx="1" fill="rgba(77,184,255,0.4)"/>
      <rect x="115" y="108" width="18" height="4" rx="1" fill="rgba(255,77,166,0.4)"/>
      <rect x="318" y="93" width="14" height="4" rx="1" fill="rgba(255,77,166,0.45)"/>
      <circle cx="194" cy="10" r="2" fill="rgba(255,80,80,0.8)"/>
      <circle cx="194" cy="10" r="4" fill="rgba(255,80,80,0.2)"/>
      <rect x="0" y="200" width="420" height="60" fill="rgba(2,5,15,0.95)"/>
      <rect x="0" y="198" width="420" height="6" fill="rgba(20,40,80,0.3)"/>
      <ellipse cx="194" cy="202" rx="80" ry="10" fill="rgba(77,184,255,0.06)"/>
      <ellipse cx="90" cy="204" rx="50" ry="8" fill="rgba(255,77,166,0.04)"/>
      <circle cx="30" cy="25" r="1" fill="rgba(255,255,255,0.4)"/>
      <circle cx="400" cy="45" r="0.8" fill="rgba(255,255,255,0.3)"/>
    </svg>`
  },
  spanish: {
